...
# default to the 4B so a 16 GB Mac is safe out of the box (~2.5 GB).
# Override with STR_DIRECTOR_MODEL=mlx-community/Qwen3-8B-4bit on a
# 24 GB+ machine for a touch more direction quality.
